...
export type DepartmentGlobalIdEnum = z.infer<
  typeof DepartmentGlobalIdEnumSchema
>

export const DisplayNameSchema = z.enum(["[1401] حمد بن يوسف القشيميط"])
export type DisplayName = z.infer<typeof DisplayNameSchema>

export const ResModelSchema = z.enum(["salary.identification.request"])
export type ResModel = z.infer<typeof ResModelSchema>

export const SectorIdEnumSchema = z.enum(["خدمات المنشآت"])
export type SectorIdEnum = z.infer<typeof SectorIdEnumSchema>

export const StateSchema = z.enum(["done"])
...
export const SalaryIdentificationElementSchema = z.object({
  ...
  department_global_id: z.array(
    z.union([DepartmentGlobalIdEnumSchema, z.number()]),
  ),
...
export type SalaryIdentificationElement = z.infer<
  typeof SalaryIdentificationElementSchema
>
