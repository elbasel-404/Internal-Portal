...
import { NewsTabsKey, type NewsTab, type AdsListRequst ,type NewsFamily, type NewsListRequest} from '@types';
...
export const NewsSection = ({ tabs, news, ads, familyNews }: NewsSectionProps) => {
