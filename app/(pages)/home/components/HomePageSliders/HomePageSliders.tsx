    ...
    <div className="flex lg:flex-row flex-col justify-between">
      ...
      <div className="bg-white lg:w-full min-w-[428px]">
        ...
        <div className="p-4">
          ...
          <Link
            href={paths.employeeDepartment.href}
            className="group bg-primary-opacity rounded-full flex items-center justify-center gap-2 p-2 font-medium shadow-none hover:bg-primary hover:text-white w-full text-primary mt-6"
          >
            <span>التفاصيل</span>
            <AngleLeftIcon
              width={6}
