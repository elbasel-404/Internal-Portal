...
interface RemoteWorkRequestProps {
  data: RemoteWorkRequest[];
}

export const RemoteWorkTable = ({ data }: RemoteWorkRequestProps) => {
    ...
    <>
      <div className='bg-white rounded-lg'>
        ...
        <Table
          ...
          link={paths.remoteWorkDetails.href}
        />
      </div>
    </>
  );
