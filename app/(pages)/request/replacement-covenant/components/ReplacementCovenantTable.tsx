...
import { ReplacementCovenantRequest } from "@types"

interface ReplacementCovenantProps {
  data: ReplacementCovenantRequest[]
}
...
export const ReplacementCovenantTable = ({
  data,
}: ReplacementCovenantProps) => {
      ...
      <div className="bg-white rounded-lg">
        <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between border-b border-border-[#ECF0F480] p-4">
          <h2 className="text-foreground font-bold text-2xl">
            قائمة طلبات الإستعاضة وإقفال العهدة
          </h2>
          <div className="flex gap-4 items-center">
            ...
            <Link
              href={paths.replacementCovenantNew.href}
        ...
        <Table
          ...
          link={paths.replacementCovenantDetails.href}
        />
      </div>
    </>
  )
