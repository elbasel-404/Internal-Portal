...
import { HrLetterRequest } from '@types';
...
const tableHeaders = [
  { label: 'تاريخ الطلب' },
  { label: 'النوع' },
  { label: 'الجهه الموجه لها' },
  { label: 'الحالة' },
];

export const HrLetterTable = ({ data }: HrLettersProps) => {
    ...
    <>
      <div className='bg-white rounded-lg'>
        ...
        <Table
          ...
          link={paths.hrLetterDetails.href}
        />
      </div>
    </>
  );
