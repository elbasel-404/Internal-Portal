...
interface EmployeeDepartmentPageProps {
  employees: Employee[];
}

export const EmployeeDepartment = ({ employees }: EmployeeDepartmentPageProps) => {
    ...
    <>
      <div className='p-4 bg-white space-y-4 rounded-2xl min-h-screen'>
        <div className='p-4 flex flex-col gap-3'>
          <h1 className='text-2xl font-bold'>في نفس الإدارة</h1>
