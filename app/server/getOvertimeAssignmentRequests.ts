...
export const getOvertimeAssignmentRequests = async (): Promise<OvertimeAssignmentRequest[]> => {
  return OvertimeAssignmentDummyData;
};

const OvertimeAssignmentDummyData: OvertimeAssignmentRequest[] = [
  {
    id: '#55465',
    date: '2024-03-10',
    applicant: 'أحمد علي',
