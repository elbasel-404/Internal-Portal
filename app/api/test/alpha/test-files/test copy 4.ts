...
// // example usage
// // Example usage of the getApiCallback function
// const { callback, createHelpers } = getApiCallback({
//   endpoint: "vacations", // Assuming 'leaves' is a valid endpoint in allEndpoints
//   operation: "list",
// });
...
//     const helpers = createHelpers(result.data);
